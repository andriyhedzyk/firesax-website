              ...
              md:text-5xl  lg:text-7xl font-bold md:tracking-[-2px]"
							...
							<div className="flex-1 flex flex-col items-center lg:items-start">
								<p className="pt-4 pb-8 md:pt-6 md:pb-12 text-[19px] leading-[25px] md:text-xl w-[170px] lg:w-full md:w-full lg:max-w-[480px] lg:text-lg text-left lg:flex">
									This Fire Sax performance is the hottest,
									coolest, most attention grabbing speciality
									act to appear at your event, with high
									octane musical performances and bursts of
									flames, this really is a have to see it to
									believe it performance.
									<br />
								</p>
								<Link to={'/booking'}>
